...
public class ViewItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView winnerName = findViewById(R.id.item_winner);
        TextView loserName = findViewById(R.id.item_loser);
        TextView points = findViewById(R.id.item_points);
        TextView sets = findViewById(R.id.item_set);
